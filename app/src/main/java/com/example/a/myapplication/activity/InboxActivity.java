...
import com.example.a.myapplication.adapter.DrawerAdapter;
...
public class InboxActivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemClickListener,RefreshListView.OnRefreshListener{
    ...
    private LinearLayout drawerLinerLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerAdapter = new DrawerAdapter(InboxActivity.this,R.layout.drawer_list_item,drawerList);
        drawerListView.setAdapter(drawerAdapter);
        drawerLinerLayout = (LinearLayout)findViewById(R.id.drawer_linear_layout);
        drawerLinerLayout.setOnClickListener(this);
        drawerImage = (ImageView)findViewById(R.id.drawer_item_image);
        drawerText = (TextView)findViewById(R.id.drawer_item_text);
        drawerImage.setImageResource(R.drawable.plusmath);
        drawerText.setText("添加邮箱帐号");
    ...
    protected void onActivityResult(int requestCode,int resultCode,Intent data) {
        switch (requestCode) {
            case addUserActivity:
                Log.d(TAG,data.getStringExtra("data_user"));
